            ...
            <ScrollReveal>
              <div className="space-y-4">
                ...
                <p className="text-zinc-300 md:text-xl">
                  We develop powerful desktop applications that streamline workflows and boost productivity.
                </p>
        ...
        <div className="container px-4 md:px-6">
          <ScrollReveal>
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
              ...
              <p className="max-w-[900px] text-zinc-500 md:text-xl/relaxed">
                Explore how we've helped our clients achieve their business goals through desktop development
              </p>
            </div>
          </ScrollReveal>
          ...
          <div className="grid md:grid-cols-2 gap-8">
              ...
              <Card className="bg-white border-none shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden h-full">
                ...
                <CardContent className="p-6">
                  ...
                  <p className="text-zinc-500 mb-4">
                    We developed a comprehensive inventory management system that helped a retail client reduce
                    inventory discrepancies by 35%.
                  </p>
            ...
            <ScrollReveal delay={0.2}>
              <Card className="bg-white border-none shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden h-full">
                ...
                <CardContent className="p-6">
                  <h3 className="text-xl font-bold mb-2">Financial Analysis Tool</h3>
                  <p className="text-zinc-500 mb-4">
                    We built a powerful financial analysis tool that improved data processing speed by 60% for a
