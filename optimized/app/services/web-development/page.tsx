        ...
        <div className="container px-4 md:px-6">
          <ScrollReveal>
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
              ...
              <p className="max-w-[900px] text-zinc-500 md:text-xl/relaxed">
                Explore how we've helped our clients achieve their business goals through web development
              </p>
            </div>
          </ScrollReveal>
          ...
          <div className="grid md:grid-cols-2 gap-8">
              ...
              <Card className="bg-white border-none shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden h-full">
                ...
                <CardContent className="p-6">
                  ...
                  <p className="text-zinc-500 mb-4">
                    We helped a retail client increase their online sales by 45% through a complete redesign of their
                    e-commerce platform.
                  </p>
            ...
            <ScrollReveal delay={0.2}>
              <Card className="bg-white border-none shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden h-full">
                ...
                <CardContent className="p-6">
                  <h3 className="text-xl font-bold mb-2">SaaS Dashboard Development</h3>
                  <p className="text-zinc-500 mb-4">
                    We built a comprehensive dashboard for a SaaS company that improved user engagement and reduced
                    customer support inquiries by 30%.
                  </p>
                  <Link href="/portfolio/saas-dashboard">
                    <Button variant="outline" className="border-zinc-900 text-zinc-900 hover:bg-zinc-900/10">
                      View Case Study
                      <ArrowRight className="ml-2 h-4 w-4" />
                    </Button>
